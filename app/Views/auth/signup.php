                    ...
                    <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                        ...
                        <form action="<?= base_url('signin/process') ?>" method="post">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="relative">
                                    <input type="password" name="konfirmasi_password" placeholder="Enter Confirm Password" class="w-full rounded-lg border <?= !isset($errors['konfirmasi_password']) ? 'border-stroke dark:border-form-strokedark' : 'border-danger dark:border-danger' ?> bg-transparent px-5 py-3 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:focus:border-primary" />
                                ...
                                <span class="text-danger text-sm"><?= isset($errors['konfirmasi_password']) ? $errors['konfirmasi_password'] : '' ?></span>
                            </div>
