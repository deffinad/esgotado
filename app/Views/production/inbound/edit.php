        ...
        <form action="<?= base_url('production/inbound/edit/process/' . $inbound['id_inbound']) ?>" method="post" enctype="multipart/form-data">
            <div>
                ...
                <div class="mb-4.5">
                    ...
                    <input type="text" name="code" id="code" value="<?= isset($input['code']) ? esc($input['code']) : $inbound['code_sku'] ?>" placeholder="Input Code/SKU" class="w-full rounded border-[1.5px] <?= !isset($errors['code']) ? 'border-stroke' : 'border-danger' ?> bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter" readonly />
                ...
                <div class="mb-4.5">
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        <div class="col-span-10">
                            <input type="number" name="amount" value="<?= isset($input['amount']) ? esc($input['amount']) : $inbound['amount_unit'] ?>" placeholder="Input Amount" class="w-full rounded border-[1.5px] <?= !isset($errors['amount']) ? 'border-stroke' : 'border-danger' ?> bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter" readonly/>
