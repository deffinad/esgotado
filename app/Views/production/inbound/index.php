                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex flex-row items-center gap-2">
                                <a href="<?= base_url('/production/inbound/edit/' . $val->id_inbound) ?>" class="transition-all duration-200 hover:text-yellow-500 dark:hover:text-white text-gray-500">
                                    <i class="far fa-edit text-lg"></i>
                                </a>
                                <a href="#" class="open-delete-modal transition-all duration-200 hover:text-red-500 dark:hover:text-white text-gray-500 cursor-pointer" data-id="<?= $val->id_inbound ?>">
