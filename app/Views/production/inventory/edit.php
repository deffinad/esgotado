                ...
                <div class="mb-4.5">
                    ...
                    <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent dark:bg-form-input">
                        <select name="type_materials" class="relative z-20 w-full appearance-none rounded border <?= !isset($errors['type_materials']) ? 'border-stroke dark:border-form-strokedark' : 'border-danger dark:border-danger' ?> bg-transparent px-5 py-3 outline-none transition focus:border-primary active:border-primary dark:bg-form-input dark:focus:border-primary" :class="isOptionSelected && 'text-black dark:text-white'" @change="isOptionSelected = true">
                            ...
                            <option value="Perawatan" <?= $input != null && isset($input['type_materials']) && $input['type_materials'] == 'Perawatan' ? 'selected' : '' ?> class="text-body">Perawatan</option>
                            <option value="Produk" <?= $input != null && isset($input['type_materials']) && $input['type_materials'] == 'Produk' ? 'selected' : '' ?> class="text-body">Produk</option>
                            <option value="Platinum" <?= $input != null && isset($input['type_materials']) && $input['type_materials'] == 'Platinum' ? 'selected' : '' ?> class="text-body">Platinum</option>
                        </select>
