                ...
                <tr>
                    ...
                    <td>
                        <div class="flex flex-row items-center gap-2">
                            <a href="/production/outbound/edit/1" class="transition-all duration-200 hover:text-yellow-500 dark:hover:text-white text-gray-500">
                                ...
                                <div x-show="modalOpen" x-transition class="fixed left-0 top-0 z-999999 flex h-full min-h-screen w-full items-center justify-center bg-black/90 px-4 py-5" style="display: none;">
                                    <div @click.outside="modalOpen = false" class="w-full max-w-142.5 rounded-lg bg-white px-8 py-12 text-center dark:bg-boxdark md:px-17.5 md:py-15">
                                        ...
                                        <div class="-mx-3 flex flex-wrap gap-y-4">
                                            ...
                                            <div class="w-full px-3 2xsm:w-1/2">
                                                <a @click="modalOpen = false" href="<?= base_url('production/outbound/delete/1') ?>" class="block w-full rounded border border-meta-1 bg-meta-1 p-3 text-center font-medium text-white transition hover:bg-opacity-90 no-underline">
                                                    Hapus
                                                </a>
                                            </div>
                                        </div>
